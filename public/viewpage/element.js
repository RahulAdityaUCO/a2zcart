...
export const formChangePassword = document.getElementById("form-changepassword")
export const formConfirmPasswordError = document.getElementById("form-confirm-password-error")



export const menuSortHigh = document.getElementById("menu-sortby-highest")
export const menuSortLow = document.getElementById("menu-sortby-lowest")
export const menuHighPrice = document.getElementById("menu-sortby-Highprice")
export const menuLowPrice = document.getElementById("menu-sortby-lowprice")

export const modalReviewTitle = document.getElementById(
    "modal-review-product-title"
  );
export const formWriteReviewProductId = document.getElementById(
    "form-review-productId"
  );

export const formWriteReview = document.getElementById("form-review-product");
export const ProductImageName = document.getElementById("form-review-productImageName")
export const ProductImageURL = document.getElementById("form-review-productURL")
export const modalReviewBody = document.getElementById("modal-review-form-body");
export const popupInfoTitle = document.getElementById("modal-popup-info-title")
...
export const googleSignInButton = document.getElementById('button-google-sign')